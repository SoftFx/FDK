...
namespace
{
	...
	const unsigned short LrpMethod_Simple_Constructor_Id = 0;
	const unsigned short LrpMethod_Simple_Inverse_Id = 1;
	const unsigned short LrpMethod_Simple_Factorial_Id = 2;

	typedef void (*LrpInvoke_Simple_Method_Handler)(size_t offset, MemoryBuffer& buffer, LrpChannel* pChannel);
	void LrpInvoke_Simple_Constructor(size_t offset, MemoryBuffer& buffer, LrpChannel* pChannel)
	{
