namespace AutomaticTrading.Sources.Indicators
{
    ...
    public class WeightedMovingAverageBinding : IndicatorBinding
    {
        ...
        public WeightedMovingAverageBinding()
            : base("Weighted Moving Average", "Weighted Moving Average", "SoftFX", "Trend")
        {
        ...
        public override IIndicator CreateIndicator(IHostContext context, IDictionary<string, object> parameters)
        {
            ...
            return new WeightedMovingAverageIndicator(period);
        }
