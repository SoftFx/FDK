...
// ---- TxtCom
if(Period()<5)
   TxtCom="Periode дndern: von M5 bis H1"; else TxtCom="";
...
//     "   Spread: "+DoubleToStr(spread,1)+"\n"+
       "Lots: "+DoubleToStr(Lots,1)+doubleTxt+"  offen: "+opOrders+"  L/S: "+(cntHistBuy+LongIsOpen)+"ґ"+(cntHistSell+ShortIsOpen)+
       "\n"+
