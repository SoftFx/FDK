...
extern int    maxPos      =   1;
       ...
       int    Ratio1      =  30; // nicht дndern!
       int    Ratio2      =  70; // nicht дndern!
       int    Ratio3      = 100; // nicht дndern! 
       int    Phase       =   0;
  ...
  OrderSelect(cnt, SELECT_BY_POS); 
   if (OrderSymbol()==Symbol() && OrderMagicNumber()==Magic) 
   {
     ...
     */
     ...
     //---- setSL1 / BUY-SL erhцhen auf OrderOpenPrice() 
     if (setSL1>0
     ...
     //---- setSL2 / BUY-SL erhцhen auf OrderOpenPrice()+modiSL
     if (setSL2>0
