...
v1.1
- Ajout de l'augmentation du SL lorsqu'un seuil dйfini est atteint pour diminuer le drawdown max.

v1.0
- Dйbuggage de l'EA original, il y avait des erreurs а la crйation, modification et fermeture des ordres.
- Ajout d'un filtre permettant de rйgler l'EA pour un sens de trading а la fois.
- Ajout du MaxSpread.
- Le magic number est mis en variable paramйtrable.
*/
...
losses=0; // Nombre de trade perdants consйcutifs
...
//---- Augmentation du SL au delа de zйro
if (SeuilSL>0
