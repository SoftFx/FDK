namespace Mql2Fdk.EncodingTools
{
    ...
    public static class EncodingDetection
    {
        ...
        static Encoding DetectOutgoingEncoding(string input, int[] preferedEncodings, bool preserveOrder)
        {
            if (input == null)
