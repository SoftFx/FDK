namespace SoftFX.Extended.Functional.Tests
{
    ...
    public class DataTradeGrossTests
    {
        ...
        void SendMarketOrder(ConnectionStringBuilder builder)
        {
            ...
            var order = this.dataTrade.Server.SendOrderEx("EURUSD", TradeCommand.Market, TradeRecordSide.Buy, 1.1, 10000, 0, null, 0, null, "comment", null, null, 1000000);
        ...
        void SendLimitOrder(ConnectionStringBuilder builder)
        {
            ...
            var order = this.dataTrade.Server.SendOrderEx("EURUSD", TradeCommand.Limit, TradeRecordSide.Buy, price, 10000, 0, null, 0, null, "comment", null, null, 1000000);
        ...
        void SendStopOrder(ConnectionStringBuilder builder)
        {
            ...
            var order = this.dataTrade.Server.SendOrderEx("EURUSD", TradeCommand.Stop, TradeRecordSide.Buy, price, 10000, 0, null, 0, null, "comment", null, null, 1000000);
            Assert.IsTrue(order.Price == price, "Invalid order price = {0}", order.Price);
        ...
        void ModifyLimitOrder(ConnectionStringBuilder builder)
        {
            ...
            var order = this.dataTrade.Server.SendOrderEx("EURUSD", TradeCommand.Limit, TradeRecordSide.Buy, 1.1, 10000, null, null, null, null, "comment", null, null, 1000000);
/*
        ...
        void ModifyPosition(ConnectionStringBuilder builder)
        {
            ...
            var start = DateTime.UtcNow;
            TradeRecord order = this.dataTrade.Server.SendOrderEx("EURUSD", TradeCommand.Market, TradeRecordSide.Buy, 0, 10000, null, null, null, null, "comment", null, null, 1000000);
        ...
        void TradeReports(ConnectionStringBuilder builder, TestContext testContext)
        {
            ...
            //Test Limit order
            var order = this.dataTrade.Server.SendOrderEx(testContext.Symbol, TradeCommand.Limit, TradeRecordSide.Buy, testContext.VeryLowPrice, testContext.Volume, null, null, null, DateTime.UtcNow.AddHours(1), testContext.Comment, null, null, 1000000);
            ...
            //Test stop order
            order = this.dataTrade.Server.SendOrderEx(testContext.Symbol, TradeCommand.Stop, TradeRecordSide.Buy, testContext.VeryHighPrice, testContext.Volume, null, null, null, DateTime.UtcNow.AddHours(1), testContext.Comment, null, null, 1000000);
        ...
        void CloseBy(ConnectionStringBuilder builder)
        {
            ...
            using (this.dataTrade = new DataTrade(connectionString))
            {
                ...
                TradeRecord order1 = this.dataTrade.Server.SendOrderEx("EURUSD", TradeCommand.Market, TradeRecordSide.Buy, 0, 10000, null, null, null, null, "comment", null, null, 1000000);
                TradeRecord order2 = this.dataTrade.Server.SendOrderEx("EURUSD", TradeCommand.Market, TradeRecordSide.Sell, 0, 10000, null, null, null, null, "comment", null, null, 1000000);
