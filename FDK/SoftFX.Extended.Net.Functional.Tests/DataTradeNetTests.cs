namespace SoftFX.Extended.Functional.Tests
{
    ...
    public class DataTradeNetTests : TestBase
    {
        ...
        void SendStopOrder(ConnectionStringBuilder builder)
        {
            ...
            var order = this.dataTrade.Server.SendOrderEx("EURUSD", TradeCommand.Stop, TradeRecordSide.Buy, price, 10000, null, null, null, null, "comment", null, null, 1000000);
            Assert.IsTrue(order.Price == price, "Invalid order price = {0}", order.Price);
            this.dataTrade.Logon -= this.OnLogon;
            this.dataTrade.Stop();
            this.dataTrade.Dispose();
        ...
        void ModifyLimitOrder(ConnectionStringBuilder builder)
        {
            ...
            var order = this.dataTrade.Server.SendOrderEx("EURUSD", TradeCommand.Limit, TradeRecordSide.Buy, price, 10000, null, null, null, null, "comment", null, null, 1000000);
            ...
            order.Modify(null, 1.0, null, null, null, null, null, null);
