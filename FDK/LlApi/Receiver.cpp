...
void CReceiver::VGetTradeTransactionReportsAndSubscribeToNotifications(const CFxEventInfo& info, const int32 reportsNumber, const bool endOfStream)
{
	pair<int32, bool> response(reportsNumber, endOfStream);
