...
namespace FIX
{
  namespace FIELD
  {
    ...
    const int StopOrderMarginReduction = 10194;
    const int MarginCurrencyToUsdConversionRate = 10195;
    const int UsdToMarginCurrencyConversionRate = 10196;
    const int MarginCurrency = 10197;
    const int ProfitCurrencyToUsdConversionRate = 10198;
    const int UsdToProfitCurrencyConversionRate = 10199;
    const int ProfitCurrency = 10200;
    const int SrcAssetToUsdConversionRate = 10201;
