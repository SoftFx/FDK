...
namespace FIX
{
  namespace FIELD
  {
    ...
    const int ApplicationPingID = 7532;
    const int StreamReference = 7533;
    const int HstFrom = 10000;
    const int HstTo = 10001;
    const int AllHstFrom = 10002;
    const int AllHstTo = 10003;
    const int NoBars = 10004;
    const int BarHi = 10005;
    const int BarLow = 10006;
    const int BarOpen = 10007;
    const int BarClose = 10008;
    const int BarTime = 10009;
    const int ForexPriceType = 10010;
    const int MarketHistReqID = 10011;
    const int HstGraphPeriodID = 10012;
    const int FileName = 10015;
    const int FileId = 10016;
    const int AttachedFileId = 10017;
    const int HstReportType = 10018;
    const int HstBinData = 10019;
    const int HstGraphType = 10020;
    const int MHstRejReason = 10021;
    const int ChunkId = 10023;
    const int ChunksNo = 10024;
    const int FileSize = 10026;
    const int AcInfReqID = 10028;
    const int Leverage = 10029;
    const int Margin = 10030;
    const int Balance = 10031;
    const int Equity = 10032;
    const int AccountingType = 10033;
    const int HstReqBars = 10035;
    const int PosID = 10036;
    const int StopLoss = 10037;
    const int TakeProfit = 10038;
    const int AccOrderType = 10039;
    const int BarVolume = 10040;
    const int BarVolumeEx = 10041;
    const int PosCloseType = 10044;
    const int ClosePosReqID = 10045;
    const int ClosePosReqResult = 10046;
    const int NotifCode = 10047;
    const int NotifSeverity = 10048;
    const int TotalNumMarketSnaps = 10049;
    const int PosClosePrice = 10050;
    const int PosClosed = 10051;
    const int PosOpened = 10052;
    const int StrmngDirection = 10053;
    const int StrmngBufSize = 10054;
    const int StrmngPosID = 10055;
    const int EndOfStrm = 10056;
    const int PxPrecision = 10057;
    const int MaxTradeVolume = 10058;
    const int ProfitCalcMode = 10059;
    const int MarginCalcMode = 10060;
    const int MarginHedge = 10061;
    const int TradeVolStep = 10062;
    const int MarginFactor = 10063;
    const int ProtocolSpec = 10064;
    const int ColorRef = 10067;
    const int NoFiles = 10068;
    const int FileReqRejReason = 10069;
    const int MDHstMetaReqID = 10070;
    const int MDHstMetaReqResult = 10071;
    const int AccBalance = 10072;
    const int AccTrAmount = 10073;
    const int AccTrCurry = 10074;
    const int EncodedCommentLen = 10075;
    const int EncodedComment = 10076;
    const int TradeTransRepRequestResult = 10077;
    const int TradeTransReportType = 10078;
    const int TradeTransReason = 10079;
    const int OrderLeavesQty = 10080;
    const int OrderPrice = 10081;
    const int OrderStopPx = 10082;
    const int OrdCreated = 10083;
    const int OrdModified = 10084;
    const int PosModified = 10085;
    const int PosOpenReqPrice = 10086;
    const int PosOpenPrice = 10087;
    const int PosQty = 10088;
    const int PosLastQty = 10089;
    const int PosLeavesQty = 10090;
    const int PosCloseReqPrice = 10091;
    const int LogoutReason = 10092;
    const int PlatformTimezoneOffset = 10093;
    const int TickId = 10094;
    const int LastTickId = 10095;
    const int Swap = 10096;
    const int AccMarginCallLevel = 10097;
    const int AccStopOutLevel = 10098;
    const int PosReportType = 10099;
    const int AccountValidFlag = 10100;
    const int InvestorLoginFlag = 10101;
    const int EncodedTagLen = 10102;
    const int EncodedTag = 10103;
    const int Magic = 10104;
    const int MarginRateInitial = 10105;
    const int MarginRateCurrent = 10106;
    const int LongPrice = 10107;
    const int ShortPrice = 10108;
    const int ParentOrderID = 10109;
    const int ClientQuoteHistoryVersion = 10110;
    const int ServerQuoteHistoryVersion = 10111;
    const int AccountName = 10112;
    ...
    const int AssetCurrency = 10120;
    const int OpenConversionRate = 10121;
    const int CloseConversionRate = 10122;
    const int LimitsCommission = 10123;
    const int CommChargeType = 10124;
    const int SwapSizeShort = 10125;
    const int SwapSizeLong = 10126;
    const int TradeEnabled = 10127;
    const int PlatformName = 10129;
    const int PlatformCompany = 10130;
    const int SortOrder = 10131;
    const int GroupSortOrder = 10132;
    const int AccountBlockedFlag = 10133;
    ...
    const int TrdSrvReqID = 10175;
    const int CompanyName = 10176;
    const int CompanyFullName = 10177;
    const int EncodedCompanyDescriptionLen = 10178;
    const int EncodedCompanyDescription = 10179;
    const int CompanyAddress = 10180;
    const int CompanyEmail = 10181;
    const int CompanyPhone = 10182;
    const int CompanyWebSite = 10183;
    const int ServerName = 10184;
    const int ServerFullName = 10185;
    const int EncodedServerDescriptionLen = 10186;
    const int EncodedServerDescription = 10187;
    const int ServerAddress = 10188;
    const int ServerFixFeedSslPort = 10189;
    const int ServerFixTradeSslPort = 10190;
    const int ServerWebSocketFeedPort = 10191;
    const int ServerWebSocketTradePort = 10192;
    const int ServerRestPort = 10193;
    const int MarginCurrencyToUsdConversionRate = 10194;
    const int UsdToMarginCurrencyConversionRate = 10195;
    const int MarginCurrency = 10196;
    const int ProfitCurrencyToUsdConversionRate = 10197;
    const int UsdToProfitCurrencyConversionRate = 10198;
    const int ProfitCurrency = 10199;
    const int SrcAssetToUsdConversionRate = 10200;
    const int UsdToSrcAssetConversionRate = 10201;
    const int DstAssetToUsdConversionRate = 10202;
    const int UsdToDstAssetConversionRate = 10203;
