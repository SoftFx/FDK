...
namespace FIX
{
  ...
  DEFINE_STRING(ClAppID);
  DEFINE_STRING(TrdSrvReqID);
  DEFINE_STRING(CompanyName);
  DEFINE_STRING(CompanyFullName);
  DEFINE_LENGTH(EncodedCompanyDescriptionLen);
  DEFINE_DATA(EncodedCompanyDescription);
  DEFINE_STRING(CompanyAddress);
  DEFINE_STRING(CompanyEmail);
  DEFINE_STRING(CompanyPhone);
  DEFINE_STRING(CompanyWebSite);
  DEFINE_STRING(ServerName);
  DEFINE_STRING(ServerFullName);
  DEFINE_LENGTH(EncodedServerDescriptionLen);
  DEFINE_DATA(EncodedServerDescription);
  DEFINE_STRING(ServerAddress);
  DEFINE_INT(ServerFixFeedSslPort);
  DEFINE_INT(ServerFixTradeSslPort);
