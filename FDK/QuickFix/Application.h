...
public:
  ...
  virtual void onLogon( const Message&, const SessionID& ) = 0;
  /// Notification of a session logging off or disconnecting
  virtual void onLogout( const Message&, const SessionID& ) = 0;
...
class NullApplication : public Application
{
  ...
  void onLogon( const Message&, const SessionID& ) {}
  void onLogout( const Message&, const SessionID& ) {}
