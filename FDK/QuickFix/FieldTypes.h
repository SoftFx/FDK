...
struct DateTime 
{
  ...
  {
    uint64 ticks = time;
    int days = static_cast<int>(ticks / (24 * 3600 * 1000));
    m_date = 2440588 + days;
    m_time = static_cast<int>(ticks % (24 * 3600 * 1000));
  }
  ...
  CDateTime toFileTime()const
  {
	  uint64 ticks = (m_date - 2440588);
	  ticks *= (1000 * 3600 * 24);
	  ticks += m_time;
