...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(int, ConfirmStatus);
    ...
    FIELD_SET_EX(double, ReportedPx);
    ...
    FIELD_SET_EX(double, MaturityNetMoney);
    ...
    FIELD_SET_EX(double, SharedCommission);
    ...
    NoCapacities() : FIX::Group(862,528,FIX::message_order(528,529,863,0)) {}
      ...
      FIELD_SET_EX(double, OrderCapacityQty);
    };
