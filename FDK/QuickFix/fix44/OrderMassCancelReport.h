...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(char, MassCancelResponse);
    FIELD_SET(*this, FIX::MassCancelRejectReason);
    FIELD_SET_EX(char, MassCancelRejectReason);
    FIELD_SET(*this, FIX::TotalAffectedOrders);
    FIELD_SET_EX(int, TotalAffectedOrders);
    ...
    FIELD_SET_EX(int, NoAffectedOrders);
    ...
    NoAffectedOrders() : FIX::Group(534,41,FIX::message_order(41,535,536,0)) {}
      ...
      FIELD_SET_EX(std::string, AffectedOrderID);
      FIELD_SET(*this, FIX::AffectedSecondaryOrderID);
      FIELD_SET_EX(std::string, AffectedSecondaryOrderID);
    };
  };
