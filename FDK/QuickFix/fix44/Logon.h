...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(int, EncryptMethod);
    FIELD_SET(*this, FIX::HeartBtInt);
    FIELD_SET_EX(int, HeartBtInt);
    ...
    NoMsgTypes() : FIX::Group(384,372,FIX::message_order(372,385,0)) {}
      ...
      FIELD_SET_EX(std::string, RefMsgType);
      FIELD_SET(*this, FIX::MsgDirection);
      FIELD_SET_EX(char, MsgDirection);
    };
  };
