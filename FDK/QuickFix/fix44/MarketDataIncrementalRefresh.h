...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(FIX::UtcTimeStamp, OrigTime);
    FIELD_SET(*this, FIX::TickId);
    FIELD_SET_EX(std::string, TickId);
    ...
    NoMDEntries() : FIX::Group(268,279,FIX::message_order(279,285,269,278,280,55,65,48,22,454,460,461,167,762,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,864,873,874,711,555,291,292,270,15,271,272,273,274,275,336,625,276,277,282,283,284,286,59,432,126,110,18,287,37,299,288,289,346,290,546,811,451,58,354,355,0)) {}
      ...
      FIELD_SET_EX(char, MDUpdateAction);
      FIELD_SET(*this, FIX::DeleteReason);
      FIELD_SET_EX(char, DeleteReason);
      FIELD_SET(*this, FIX::MDEntryType);
      FIELD_SET_EX(char, MDEntryType);
      FIELD_SET(*this, FIX::MDEntryID);
      FIELD_SET_EX(std::string, MDEntryID);
      FIELD_SET(*this, FIX::MDEntryRefID);
      FIELD_SET_EX(std::string, MDEntryRefID);
      ...
      FIELD_SET_EX(double, MDEntryPx);
      FIELD_SET(*this, FIX::Currency);
      FIELD_SET_EX(std::string, Currency);
      FIELD_SET(*this, FIX::MDEntrySize);
      FIELD_SET_EX(double, MDEntrySize);
      FIELD_SET(*this, FIX::MDEntryDate);
      FIELD_SET_EX(FIX::UtcDate, MDEntryDate);
      FIELD_SET(*this, FIX::MDEntryTime);
      FIELD_SET_EX(FIX::UtcTimeOnly, MDEntryTime);
      FIELD_SET(*this, FIX::TickDirection);
      FIELD_SET_EX(char, TickDirection);
      ...
      FIELD_SET_EX(std::string, MDEntryOriginator);
      ...
      FIELD_SET_EX(std::string, MDEntryBuyer);
      FIELD_SET(*this, FIX::MDEntrySeller);
      FIELD_SET_EX(std::string, MDEntrySeller);
      FIELD_SET(*this, FIX::NumberOfOrders);
      FIELD_SET_EX(int, NumberOfOrders);
      FIELD_SET(*this, FIX::MDEntryPositionNo);
      FIELD_SET_EX(int, MDEntryPositionNo);
      FIELD_SET(*this, FIX::Scope);
      FIELD_SET(*this, FIX::PriceDelta);
      FIELD_SET_EX(double, PriceDelta);
