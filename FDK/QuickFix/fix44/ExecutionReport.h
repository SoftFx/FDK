...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(std::string, OrdStatusReqID);
    ...
    FIELD_SET_EX(int, TotNumReports);
    ...
    FIELD_SET_EX(double, PeggedPrice);
    FIELD_SET(*this, FIX::DiscretionPrice);
    FIELD_SET_EX(double, DiscretionPrice);
    ...
    FIELD_SET_EX(double, TargetStrategyPerformance);
    ...
    FIELD_SET_EX(double, DayOrderQty);
    FIELD_SET(*this, FIX::DayCumQty);
    FIELD_SET_EX(double, DayCumQty);
    FIELD_SET(*this, FIX::DayAvgPx);
    FIELD_SET_EX(double, DayAvgPx);
    ...
    FIELD_SET_EX(bool, ReportToExch);
    ...
    FIELD_SET_EX(bool, TradedFlatSwitch);
    FIELD_SET(*this, FIX::BasisFeatureDate);
    FIELD_SET_EX(std::string, BasisFeatureDate);
    FIELD_SET(*this, FIX::BasisFeaturePrice);
    FIELD_SET_EX(double, BasisFeaturePrice);
    ...
    FIELD_SET_EX(FIX::UtcTimeStamp, ExecValuationPoint);
    FIELD_SET(*this, FIX::ExecPriceType);
    FIELD_SET_EX(char, ExecPriceType);
    FIELD_SET(*this, FIX::ExecPriceAdjustment);
    FIELD_SET_EX(double, ExecPriceAdjustment);
    FIELD_SET(*this, FIX::PriorityIndicator);
    FIELD_SET_EX(int, PriorityIndicator);
    FIELD_SET(*this, FIX::PriceImprovement);
    FIELD_SET(*this, FIX::LastLiquidityInd);
    FIELD_SET_EX(int, LastLiquidityInd);
    ...
    NoContraBrokers() : FIX::Group(382,375,FIX::message_order(375,337,437,438,655,0)) {}
      ...
      FIELD_SET_EX(std::string, ContraBroker);
      FIELD_SET(*this, FIX::ContraTrader);
      FIELD_SET_EX(std::string, ContraTrader);
      FIELD_SET(*this, FIX::ContraTradeQty);
      FIELD_SET_EX(double, ContraTradeQty);
      FIELD_SET(*this, FIX::ContraTradeTime);
      FIELD_SET_EX(FIX::UtcTimeStamp, ContraTradeTime);
      FIELD_SET(*this, FIX::ContraLegRefID);
      FIELD_SET_EX(std::string, ContraLegRefID);
    };
