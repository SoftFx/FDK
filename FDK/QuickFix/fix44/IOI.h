...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(char, IOITransType);
    FIELD_SET(*this, FIX::IOIRefID);
    FIELD_SET_EX(std::string, IOIRefID);
    ...
    FIELD_SET_EX(std::string, IOIQty);
    ...
    FIELD_SET_EX(char, IOIQltyInd);
    FIELD_SET(*this, FIX::IOINaturalFlag);
    FIELD_SET_EX(bool, IOINaturalFlag);
    ...
    FIELD_SET_EX(std::string, URLLink);
    ...
    NoLegs() : FIX::Group(555,600,FIX::message_order(600,601,602,603,604,607,608,609,764,610,611,248,249,250,251,252,253,257,599,596,597,598,254,612,942,613,614,615,616,617,618,619,620,621,622,623,624,556,740,739,955,956,682,683,0)) {}
      ...
      FIELD_SET_EX(std::string, LegIOIQty);
    ...
    FIELD_SET_EX(int, NoIOIQualifiers);
    ...
    NoIOIQualifiers() : FIX::Group(199,104,FIX::message_order(104,0)) {}
      ...
      FIELD_SET_EX(char, IOIQualifier);
    };
    FIELD_SET(*this, FIX::NoRoutingIDs);
    FIELD_SET_EX(int, NoRoutingIDs);
    ...
    NoRoutingIDs() : FIX::Group(215,216,FIX::message_order(216,217,0)) {}
      ...
      FIELD_SET_EX(int, RoutingType);
      FIELD_SET(*this, FIX::RoutingID);
      FIELD_SET_EX(std::string, RoutingID);
    };
  };
