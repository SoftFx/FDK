...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(std::string, CollInquiryID);
    FIELD_SET(*this, FIX::CollInquiryStatus);
    FIELD_SET_EX(int, CollInquiryStatus);
    FIELD_SET(*this, FIX::CollInquiryResult);
    FIELD_SET_EX(int, CollInquiryResult);
    ...
    FIELD_SET_EX(int, NoCollInquiryQualifier);
    ...
    NoCollInquiryQualifier() : FIX::Group(938,896,FIX::message_order(896,0)) {}
      ...
      FIELD_SET_EX(int, CollInquiryQualifier);
    };
