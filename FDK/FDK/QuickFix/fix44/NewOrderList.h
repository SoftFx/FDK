...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(char, ListExecInstType);
    FIELD_SET(*this, FIX::ListExecInst);
    FIELD_SET_EX(std::string, ListExecInst);
    FIELD_SET(*this, FIX::EncodedListExecInstLen);
    FIELD_SET_EX(int, EncodedListExecInstLen);
    FIELD_SET(*this, FIX::EncodedListExecInst);
    FIELD_SET_EX(std::string, EncodedListExecInst);
    FIELD_SET(*this, FIX::AllowableOneSidednessPct);
    FIELD_SET_EX(double, AllowableOneSidednessPct);
    FIELD_SET(*this, FIX::AllowableOneSidednessValue);
    FIELD_SET_EX(double, AllowableOneSidednessValue);
    FIELD_SET(*this, FIX::AllowableOneSidednessCurr);
    FIELD_SET_EX(std::string, AllowableOneSidednessCurr);
