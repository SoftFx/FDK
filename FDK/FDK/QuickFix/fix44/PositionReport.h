...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(int, SettlPriceType);
    FIELD_SET(*this, FIX::PriorSettlPrice);
    FIELD_SET_EX(double, PriorSettlPrice);
    ...
    FIELD_SET_EX(char, RegistStatus);
    FIELD_SET(*this, FIX::DeliveryDate);
    FIELD_SET_EX(std::string, DeliveryDate);
    ...
    FIELD_SET(*this, FIX::PosReportType);
    FIELD_SET_EX(int, PosReportType);
    ...
    NoUnderlyings() : FIX::Group(711,311,FIX::message_order(311,312,309,305,457,462,463,310,763,313,542,241,242,243,244,245,246,256,595,592,593,594,247,316,941,317,436,435,308,306,362,363,307,364,365,877,878,318,879,810,882,883,884,885,886,732,733,0)) {}
      ...
      FIELD_SET_EX(double, UnderlyingSettlPrice);
      FIELD_SET(*this, FIX::UnderlyingSettlPriceType);
      FIELD_SET_EX(int, UnderlyingSettlPriceType);
    };
  };
