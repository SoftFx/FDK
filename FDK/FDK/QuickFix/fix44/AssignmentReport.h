...
namespace FIX44
{
  ...
  public:
    ...
    FIELD_SET_EX(std::string, AsgnRptID);
    FIELD_SET(*this, FIX::TotNumAssignmentReports);
    FIELD_SET_EX(int, TotNumAssignmentReports);
    ...
    FIELD_SET_EX(char, AssignmentMethod);
    FIELD_SET(*this, FIX::AssignmentUnit);
    FIELD_SET_EX(double, AssignmentUnit);
    FIELD_SET(*this, FIX::OpenInterest);
    FIELD_SET_EX(double, OpenInterest);
    FIELD_SET(*this, FIX::ExerciseMethod);
    FIELD_SET_EX(char, ExerciseMethod);
