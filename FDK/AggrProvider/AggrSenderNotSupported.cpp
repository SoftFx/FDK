...
void CAggrSender::VSendTwoFactorResponse(const FxTwoFactorReason /*reason*/, const std::string& /*otp*/)
{
    throw std::runtime_error("Two factor auth operation is not supported by aggregator provider.");
}
