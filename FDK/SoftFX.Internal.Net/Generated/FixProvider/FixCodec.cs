...
{
	internal class FixCodecRaw
	{
		private readonly IClient m_client;
		public FixCodecRaw(IClient client)
		{
			if(null == client)
			{
		...
		public void EncodeFast(SoftFX.Lrp.LPtr handle, SoftFX.Extended.Quote[] quotes)
		{
			using(MemoryBuffer buffer = m_client.Create())
			{
				buffer.WriteLocalPointer(handle);
...
namespace SoftFX.Internal.Generated.FixProvider
{
	internal class FixCodecProxy : System.IDisposable
	{
		public FixCodecRaw Instance { get; private set; }
		...
		public void EncodeFast(SoftFX.Extended.Quote[] quotes)
		{
			this.Instance.EncodeFast(this.Handle, quotes);
		}
		public bool Is_Clear_Supported
		{
			get
