...
namespace FDK
{
    ...
    public: // gets and sets of stop price
        inline Nullable<double> GetStopPrice() const { return m_stopPrice; }
        LLCOMMON_API void SetStopPrice(const Nullable<double> newStopPrice);
