...
//|  -Position wird geцffnet, wenn der akt. Kurs ьber/unter der Erцffnungslinie liegt
//|   und der Abstand des Hцchst-/Tiefst-Kurses zum Erцffnungskurs grцЯer ist als der Vergleichskurs. 
//|   z.B. Erцffnung 1.3250, bisheriges iHigh 1.3290 = 40 Pips
//|                                     iLow  1.3220 = 30 Pips : Longposition wird geцffnet!
//|  -Bei Aktivierung von "HoldingHours" wird nach Erreichen die positive Position geschlossen, bei
//|   der negativen Position wird der TakeProfit-Wert auf den Erцffnungskurs gesetzt.
//|  -DayTrading-Ende ist um 18:00 GMT. Alle noch offenen Positionen werden sofort geschlossen.
//|  -Die Aktivierung von "ProfitStop" schlieЯt alle Positionen beim Erreichen dieser Tages-Bilanz.
//+--------------------------------------------------------------------------------------------------+
