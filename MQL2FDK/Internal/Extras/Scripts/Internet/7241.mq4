...
int    Signal=1;     // 0 raada tikai punktinjus, 1 rвda punktinjus un bultinju, 2 raada tikai bultinju
int    Line=1;       // 0 nerвda lоnijas , 1 raada   
...
int Write(string str)
{
   ...
   Print (">>> "+ str + " Time " + TimeToStr(CurTime(),TIME_DATE|TIME_SECONDS)); // dublзjam uz ekrвna
}
