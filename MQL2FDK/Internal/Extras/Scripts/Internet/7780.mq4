...
//+------------------------------------------------------------------+
   if((TimeFrameM1==true && Period()==1) || (TimeFrameM5==true  && Period()==5) || (TimeFrameM15==true  && Period()==15) || (TimeFrameM30==true  && Period()==30) || (TimeFrameM60==true && Period()==60)  || (TimeFrameM240==true && Period()==240) )
      ...
      if (OrdersTotal() == 3 && Maxiposition > 3 && (AccountEquity()*100/AccountMargin()) >500)
         {
      ...
      if (OrdersTotal() == 4 && Maxiposition > 4 && (AccountEquity()*100/AccountMargin()) >500)
         {
...
//+------------------------------------------------------------------+
   if((AccountEquity()*100/AccountMargin())<Stopoutlevel )
      {
      CloseAll();
      Sellvalue=0;
      B1 = 0;
...
string comments="";
   ...
   "  |Margin Level:-->" + DoubleToStr(AccountEquity()*100/AccountMargin(),2) + "%" +"\n"+
   ...
   "  |Maximum position:-->" + DoubleToStr(NormalizeDouble(AccountFreeMargin()/AccountLeverage(),1),0)+
   "  |Period is "+ Period() +
